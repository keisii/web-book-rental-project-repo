...
public class AdminMemberController {
	...
	public String modifyAccountConfirm(AdminMemberModifyVo adminMemberModifyVo, HttpSession session) {
		System.out.println("[AdminMemberController] modifyAccountConfirm()");
		
		String nextPage = "admin/member/modify_account_ok";
		
		int result = adminMemberService.modifyAccountConfirm(adminMemberModifyVo);
		
		if (result > 0) {
			AdminMemberVo loginedAdminMemberVo = adminMemberService.getLoginedAdminMemberVo(adminMemberModifyVo.getA_m_no());
