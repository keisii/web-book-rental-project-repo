...
public class AdminMemberDao {
	...
	public AdminMemberVo selectedAdmin(AdminMemberVo adminMemberVo) {
	...
	public int updateAdminAccount(AdminMemberModifyVo adminMemberModifyVo) {
		System.out.println("[AdminMemberDao] updateAdminAccount()");

		String sql = "UPDATE tbl_admin_member SET " + "a_m_pw = ?, a_m_name = ?, a_m_gender = ?, "
				+ "a_m_part = ?, a_m_position = ?, " + "a_m_mail = ?, a_m_phone = ?, "
				+ "a_m_mod_date = NOW() WHERE a_m_no = ?";

		int result = -1;

		try {
			result = jdbcTemplate.update(sql, passwordEncoder.encode(adminMemberModifyVo.getA_m_newpw()),
					adminMemberModifyVo.getA_m_name(), adminMemberModifyVo.getA_m_gender(),
					adminMemberModifyVo.getA_m_part(), adminMemberModifyVo.getA_m_position(),
					adminMemberModifyVo.getA_m_mail(), adminMemberModifyVo.getA_m_phone(),
					adminMemberModifyVo.getA_m_no());
	...
	public AdminMemberVo selectedAdmin(AdminMemberModifyVo adminMemberModifyVo) {
		System.out.println("[AdminMemberDao] selectedAdmin()");
