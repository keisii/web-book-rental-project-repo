		...
		<div id="section_wrap">
			...
			<div class="modify_account_form">
				...
				<form action="<c:url value='/admin/member/modifyAccountConfirm' />" name="modify_account_form" method="post">
					...
					<input type="password" name="a_m_pw" placeholder="INPUT CURRENT PASSWORD."> <br>
					<input type="password" name="a_m_newpw" placeholder="INPUT NEW PASSWORD."> <br>
					<input type="password" name="a_m_newpw_again" placeholder="INPUT NEW PASSWORD AGAIN."> <br>
